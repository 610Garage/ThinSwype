...
${OBJECTDIR}/R_NFC.o: R_NFC.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/R_NFC.o R_NFC.c

${OBJECTDIR}/UserInfo.o: UserInfo.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserInfo.o UserInfo.c
...
${OBJECTDIR}/mifare.o: mifare.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mifare.o mifare.c

${OBJECTDIR}/nfc-utils.o: nfc-utils.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nfc-utils.o nfc-utils.c
